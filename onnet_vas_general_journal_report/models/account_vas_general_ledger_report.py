...
class VASGeneralLedgerCustomHandler(models.AbstractModel):
    _name = 'vas.general.ledger.report.handler'
    _inherit = 'account.report.custom.handler'
    _description = 'VAS General Ledger Custom Handler'
    ...
    def _dynamic_lines_generator(self, report, options, all_column_groups_expression_totals, warnings=None):
        ...
        for account, column_group_results in self._query_values(report, options):
            ...
            lines += self._get_account_title_line(report, options, account, has_lines, eval_dict)
    ...
    def _get_account_title_line(self, report, options, account, has_lines, eval_dict):
        ...
        child_lines = self._report_expand_unfoldable_line_general_ledger(line_id, groupby=None, options=options, progress=None, offset=0, unfold_all_batch_data=None)
        return child_lines.get('lines', [])
